...
SECRET_KEY = os.environ.get('DJANGO_SECRET_KEY', 'u0kv_gunyha45%_c(=pxhn%ocx++#-cz32-!^@bby%6i_#lu6d')

ALLOWED_HOSTS = list()
ALLOWED_HOSTS.append('localhost')
ALLOWED_HOSTS.append(os.environ.get('ALLOWED_WEB_HOST', 'localhost'))
